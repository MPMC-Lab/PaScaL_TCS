...
module PaScaL_TDMA
    ...
    subroutine PaScaL_TDMA_many_solve(plan, A, B, C, D, n_sys, n_row)
        ...
        call MPI_Alltoallw( plan%A_rd, plan%count_send, plan%displ_send, plan%ddtype_Fs, &
                            plan%A_rt, plan%count_recv, plan%displ_recv, plan%ddtype_Bs, &
                            plan%ptdma_world, ierr)
        call MPI_Alltoallw( plan%B_rd, plan%count_send, plan%displ_send, plan%ddtype_Fs, &
                            plan%B_rt, plan%count_recv, plan%displ_recv, plan%ddtype_Bs, &
                            plan%ptdma_world, ierr)
        call MPI_Alltoallw( plan%C_rd, plan%count_send, plan%displ_send, plan%ddtype_Fs, &
                            plan%C_rt, plan%count_recv, plan%displ_recv, plan%ddtype_Bs, &
                            plan%ptdma_world, ierr)
        call MPI_Alltoallw( plan%D_rd, plan%count_send, plan%displ_send, plan%ddtype_Fs, &
        ...
        call MPI_Alltoallw( plan%D_rt, plan%count_recv, plan%displ_recv, plan%ddtype_Bs, &
    ...
    !>
    !> @brief   Solve many tridiagonal systems of equations: Nonblocking communication version.
    !> @param   plan        Plan for many tridiagonal systems of equations
    !> @param   A           Coefficients in lower diagonal elements
    !> @param   B           Coefficients in diagonal elements
    !> @param   C           Coefficients in upper diagonal elements
    ...
    !> @param   n_row       Number of rows in each process, size of a tridiagonal matrix N divided by nprocs
    !>
    subroutine PaScaL_TDMA_many_solve_nonblocking(plan, A, B, C, D, n_sys, n_row)
    ...
    end subroutine PaScaL_TDMA_many_solve_nonblocking
    ...
    !>
    !> @brief   Solve many cyclic tridiagonal systems of equations: Nonblocking communication version.
    !> @param   plan        Plan for many tridiagonal systems of equations
    !> @param   A           Coefficients in lower diagonal elements
    !> @param   B           Coefficients in diagonal elements
    !> @param   C           Coefficients in upper diagonal elements
    ...
    !> @param   n_row       Number of rows in each process, size of a tridiagonal matrix N divided by nprocs
    !>
    subroutine PaScaL_TDMA_many_solve_cycle_nonblocking(plan, A, B, C, D, n_sys, n_row)
    ...
    end subroutine PaScaL_TDMA_many_solve_cycle_nonblocking
